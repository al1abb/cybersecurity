...
* [Pentester Path](hack-the-box/pentester-path/README.md)
  ...
  * [Password Attacks](hack-the-box/pentester-path/password-attacks/README.md)
    ...
    * [Password Cracking Techniques](hack-the-box/pentester-path/password-attacks/password-cracking-techniques/README.md)
      * [Introduction to Password Cracking](hack-the-box/pentester-path/password-attacks/password-cracking-techniques/introduction-to-password-cracking.md)
      * [Introduction to John The Ripper](hack-the-box/pentester-path/password-attacks/introduction/john-the-ripper.md)
      * [Introduction to Hashcat](hack-the-box/pentester-path/password-attacks/password-cracking-techniques/introduction-to-hashcat.md)
      * [Writing Custom Wordlists and Rules](hack-the-box/pentester-path/password-attacks/remote-password-attacks/password-mutations.md)
      * [Cracking Protected Files](hack-the-box/pentester-path/password-attacks/cracking-files/protected-files.md)
      * [Cracking Protected Archives](hack-the-box/pentester-path/password-attacks/cracking-files/protected-archives.md)
    * [Remote Password Attacks](hack-the-box/pentester-path/password-attacks/remote-password-attacks/README.md)
      * [Network Services (NEW)](hack-the-box/pentester-path/password-attacks/remote-password-attacks/network-services-new.md)
      * [Spraying, Stuffing, and Defaults](hack-the-box/pentester-path/password-attacks/remote-password-attacks/spraying-stuffing-and-defaults.md)
      * [Network Services (OLD)](hack-the-box/pentester-path/password-attacks/remote-password-attacks/network-services-old.md)
      * [Password Reuse / Default Passwords (OLD)](hack-the-box/pentester-path/password-attacks/remote-password-attacks/password-reuse-default-passwords-old.md)
    * [Extracting Passwords from Windows Systems](hack-the-box/pentester-path/password-attacks/extracting-passwords-from-windows-systems/README.md)
      * [Windows Authentication Process](hack-the-box/pentester-path/password-attacks/extracting-passwords-from-windows-systems/windows-authentication-process.md)
      * [Attacking SAM, SYSTEM, and SECURITY](hack-the-box/pentester-path/password-attacks/extracting-passwords-from-windows-systems/attacking-sam-system-and-security.md)
      * [Attacking LSASS](hack-the-box/pentester-path/password-attacks/extracting-passwords-from-windows-systems/attacking-lsass.md)
      * [Attacking Windows Credential Manager](hack-the-box/pentester-path/password-attacks/extracting-passwords-from-windows-systems/attacking-windows-credential-manager.md)
      * [Attacking Active Directory & NTDS.dit](hack-the-box/pentester-path/password-attacks/extracting-passwords-from-windows-systems/attacking-active-directory-and-ntds.dit.md)
      * [Credential Hunting in Windows](hack-the-box/pentester-path/password-attacks/extracting-passwords-from-windows-systems/credential-hunting-in-windows.md)
    ...
    * [Windows Lateral Movement](hack-the-box/pentester-path/password-attacks/windows-lateral-movement/README.md)
      ...
      * [Pass the Certificate](hack-the-box/pentester-path/password-attacks/windows-lateral-movement/pass-the-certificate.md)
  ...
  * [Web Attacks](hack-the-box/pentester-path/web-attacks/README.md)
    * [Introduction to Web Attacks](hack-the-box/pentester-path/web-attacks/introduction-to-web-attacks.md)
    ...
    * [Insecure Direct Object References (IDOR)](hack-the-box/pentester-path/web-attacks/insecure-direct-object-references-idor/README.md)
      ...
      * [IDOR Prevention](hack-the-box/pentester-path/web-attacks/insecure-direct-object-references-idor/idor-prevention.md)
    * [XML External Entity (XXE) Injection](hack-the-box/pentester-path/web-attacks/xml-external-entity-xxe-injection/README.md)
      ...
      * [XXE Prevention](hack-the-box/pentester-path/web-attacks/xml-external-entity-xxe-injection/xxe-prevention.md)
  * [Attacking Common Applications](hack-the-box/pentester-path/attacking-common-applications/README.md)
    ...
    * [Content Management Systems (CMS)](hack-the-box/pentester-path/attacking-common-applications/content-management-systems-cms/README.md)
      ...
      * [Attacking WordPress](hack-the-box/pentester-path/attacking-common-applications/content-management-systems-cms/attacking-wordpress.md)
      * [Joomla - Discovery & Enumeration](hack-the-box/pentester-path/attacking-common-applications/content-management-systems-cms/joomla-discovery-and-enumeration.md)
    ...
    * [Miscellaneous Applications](hack-the-box/pentester-path/attacking-common-applications/miscellaneous-applications/README.md)
      ...
      * [Web Mass Assignment Vulnerabilities](hack-the-box/pentester-path/attacking-common-applications/miscellaneous-applications/web-mass-assignment-vulnerabilities.md)
  ...
  * [Linux Privilege Escalation](hack-the-box/pentester-path/linux-privilege-escalation/README.md)
    ...
    * [Environment-based Privilege Escalation](hack-the-box/pentester-path/linux-privilege-escalation/environment-based-privilege-escalation/README.md)
    ...
    * [Permissions-based Privilege Escalation](hack-the-box/pentester-path/linux-privilege-escalation/permissions-based-privilege-escalation/README.md)
      ...
      * [Sudo Rights Abuse](hack-the-box/pentester-path/linux-privilege-escalation/permissions-based-privilege-escalation/sudo-rights-abuse.md)
      * [Privileged Groups](hack-the-box/pentester-path/linux-privilege-escalation/permissions-based-privilege-escalation/privileged-groups.md)
      * [Capabilities](hack-the-box/pentester-path/linux-privilege-escalation/permissions-based-privilege-escalation/capabilities.md)
    ...
    * [Linux Internals-based Privilege Escalation](hack-the-box/pentester-path/linux-privilege-escalation/linux-internals-based-privilege-escalation/README.md)
      ...
      * [Shared Libraries](hack-the-box/pentester-path/linux-privilege-escalation/linux-internals-based-privilege-escalation/shared-libraries.md)
      * [Shared Object Hijacking](hack-the-box/pentester-path/linux-privilege-escalation/linux-internals-based-privilege-escalation/shared-object-hijacking.md)
    ...
    * [Recent 0-Days](hack-the-box/pentester-path/linux-privilege-escalation/recent-0-days/README.md)
      ...
      * [Dirty Pipe](hack-the-box/pentester-path/linux-privilege-escalation/recent-0-days/dirty-pipe.md)
      * [Netfilter](hack-the-box/pentester-path/linux-privilege-escalation/recent-0-days/netfilter.md)
  ...
  * [Windows Privilege Escalation](hack-the-box/pentester-path/windows-privilege-escalation/README.md)
    ...
    * [Attacking the OS](hack-the-box/pentester-path/windows-privilege-escalation/attacking-the-os/README.md)
      ...
      * [Weak Permissions](hack-the-box/pentester-path/windows-privilege-escalation/attacking-the-os/weak-permissions.md)
  ...
  * [Documentation & Reporting](hack-the-box/pentester-path/documentation-and-reporting/README.md)
    * [Introduction to Documentation and Reporting](hack-the-box/pentester-path/documentation-and-reporting/introduction-to-documentation-and-reporting.md)
    * [Preparation](hack-the-box/pentester-path/documentation-and-reporting/preparation/README.md)
  ...
  * [Attacking Enterprise Networks](hack-the-box/pentester-path/attacking-enterprise-networks/README.md)
    ...
    * [Lateral Movement & Privilege Escalation](hack-the-box/pentester-path/attacking-enterprise-networks/lateral-movement-and-privilege-escalation/README.md)
      ...
      * [Post-Exploitation](hack-the-box/pentester-path/attacking-enterprise-networks/lateral-movement-and-privilege-escalation/post-exploitation.md)
    * [Wrapping Up](hack-the-box/pentester-path/attacking-enterprise-networks/wrapping-up/README.md)
      * [Engagement Closeout](hack-the-box/pentester-path/attacking-enterprise-networks/wrapping-up/engagement-closeout.md)
      * [Beyond This Module](hack-the-box/pentester-path/attacking-enterprise-networks/wrapping-up/beyond-this-module.md)
* [Bug Bounty Hunter Path](hack-the-box/bug-bounty-hunter-path/README.md)
  * [Web Requests](hack-the-box/bug-bounty-hunter-path/web-requests/README.md)
    ...
    * [HTTP Methods](hack-the-box/bug-bounty-hunter-path/web-requests/http-methods/README.md)
      ...
      * [CRUD API](hack-the-box/bug-bounty-hunter-path/web-requests/http-methods/crud-api.md)
  * [Introduction to Web Applications](hack-the-box/bug-bounty-hunter-path/introduction-to-web-applications/README.md)
    * [Intro](hack-the-box/bug-bounty-hunter-path/introduction-to-web-applications/intro/README.md)
      ...
      * [Front End vs. Back End](hack-the-box/bug-bounty-hunter-path/introduction-to-web-applications/intro/front-end-vs.-back-end.md)
    * [Front End Components](hack-the-box/bug-bounty-hunter-path/introduction-to-web-applications/front-end-components/README.md)
      * [HTML](hack-the-box/bug-bounty-hunter-path/introduction-to-web-applications/front-end-components/html.md)
      * [Cascading Style Sheets (CSS)](hack-the-box/bug-bounty-hunter-path/introduction-to-web-applications/front-end-components/cascading-style-sheets-css.md)
      * [JavaScript](hack-the-box/bug-bounty-hunter-path/introduction-to-web-applications/front-end-components/javascript.md)
  ...
  * [Using Web Proxies](https://ali-10.gitbook.io/cybersecurity/hack-the-box/pentester-path/using-web-proxies)
  * [Information Gathering - Web Edition](https://ali-10.gitbook.io/cybersecurity/hack-the-box/pentester-path/information-gathering-web-edition)
  * [Attacking Web Applications with Ffuf](https://ali-10.gitbook.io/cybersecurity/hack-the-box/pentester-path/attacking-web-applications-with-ffuf)
  * [JavaScript Deobfuscation](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/README.md)
    * [Introduction](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/introduction.md)
    * [Source Code](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/source-code.md)
    * [Obfuscation](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/obfuscation/README.md)
      * [Code Obfuscation](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/obfuscation/code-obfuscation.md)
      * [Basic Obfuscation](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/obfuscation/basic-obfuscation.md)
      * [Advanced Obfuscation](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/obfuscation/advanced-obfuscation.md)
      * [Deobfuscation](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/obfuscation/deobfuscation.md)
    * [Deobfuscation Examples](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/deobfuscation-examples/README.md)
      * [Code Analysis](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/deobfuscation-examples/code-analysis.md)
      * [HTTP Requests](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/deobfuscation-examples/http-requests.md)
      * [Decoding](hack-the-box/bug-bounty-hunter-path/javascript-deobfuscation/deobfuscation-examples/decoding.md)
  * [Cross-Site Scripting](https://ali-10.gitbook.io/cybersecurity/hack-the-box/pentester-path/cross-site-scripting-xss)
  * [SQL Injection Fundamentals](https://ali-10.gitbook.io/cybersecurity/hack-the-box/pentester-path/sql-injection-fundamentals)
  ...
  * [Server-side Attacks](hack-the-box/bug-bounty-hunter-path/server-side-attacks.md)
    ...
    * [SSRF](hack-the-box/bug-bounty-hunter-path/server-side-attacks/ssrf/README.md)
      ...
      * [Preventing SSRF](hack-the-box/bug-bounty-hunter-path/server-side-attacks/ssrf/preventing-ssrf.md)
    * [SSTI](hack-the-box/bug-bounty-hunter-path/server-side-attacks/ssti/README.md)
  ...
  * [Login Brute Forcing](https://ali-10.gitbook.io/cybersecurity/hack-the-box/pentester-path/login-brute-forcing)
  * [Broken Authentication](hack-the-box/bug-bounty-hunter-path/broken-authentication/README.md)
    ...
    * [Session Attacks](hack-the-box/bug-bounty-hunter-path/broken-authentication/session-attacks/README.md)
      ...
      * [Further Session Attacks](hack-the-box/bug-bounty-hunter-path/broken-authentication/session-attacks/further-session-attacks.md)
  * [Web Attacks](https://ali-10.gitbook.io/cybersecurity/hack-the-box/pentester-path/web-attacks)
  ...
  * [Session Security](hack-the-box/bug-bounty-hunter-path/session-security/README.md)
    ...
    * [Session Attacks](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/README.md)
      ...
      * [Cross-Site Request Forgery (GET-based)](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/cross-site-request-forgery-get-based.md)
      * [Cross-Site Request Forgery (POST-based)](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/cross-site-request-forgery-post-based.md)
      * [XSS & CSRF Chaining](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/xss-and-csrf-chaining.md)
      * [Exploiting Weak CSRF Tokens](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/exploiting-weak-csrf-tokens.md)
      * [Additional CSRF Protection Bypasses](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/additional-csrf-protection-bypasses.md)
      * [Open Redirect](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/open-redirect.md)
      * [Remediation Advice](hack-the-box/bug-bounty-hunter-path/session-security/session-attacks/remediation-advice.md)
  * [Web Service & API Attacks](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/README.md)
    * [Introduction to Web Services and APIs](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/introduction-to-web-services-and-apis.md)
    * [Web Services Description Language (WSDL)](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/web-services-description-language-wsdl.md)
    * [Web Service Attacks](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/web-service-attacks/README.md)
      * [SOAPAction Spoofing](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/web-service-attacks/soapaction-spoofing.md)
      * [Command Injection](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/web-service-attacks/command-injection.md)
    ...
    * [API Attacks](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/api-attacks/README.md)
      ...
      * [Local File Inclusion (LFI)](hack-the-box/bug-bounty-hunter-path/web-service-and-api-attacks/api-attacks/local-file-inclusion-lfi.md)
  ...
  * [Hacking WordPress](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/README.md)
    ...
    * [Enumeration](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/README.md)
      * [WordPress Core Version Enumeration](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/wordpress-core-version-enumeration.md)
      * [Plugins and Themes Enumeration](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/plugins-and-themes-enumeration.md)
      * [Directory Indexing](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/directory-indexing.md)
      * [User Enumeration](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/user-enumeration.md)
      * [Login](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/login.md)
      * [WPScan Overview](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/wpscan-overview.md)
      * [WPScan Enumeration](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/enumeration/wpscan-enumeration.md)
    * [Exploitation](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/exploitation/README.md)
      * [Exploiting a Vulnerable Plugin](hack-the-box/bug-bounty-hunter-path/hacking-wordpress/exploitation/exploiting-a-vulnerable-plugin.md)
  ...
  * [Bug Bounty Hunting Process](hack-the-box/bug-bounty-hunter-path/bug-bounty-hunting-process/README.md)
    * [Bug Bounty Programs](hack-the-box/bug-bounty-hunter-path/bug-bounty-hunting-process/bug-bounty-programs.md)
    * [Writing a Good Report](hack-the-box/bug-bounty-hunter-path/bug-bounty-hunting-process/writing-a-good-report.md)
    * [Interacting with Organizations/BBP Hosts](hack-the-box/bug-bounty-hunter-path/bug-bounty-hunting-process/interacting-with-organizations-bbp-hosts.md)
    * [Example 1: Reporting Stored XSS](hack-the-box/bug-bounty-hunter-path/bug-bounty-hunting-process/example-1-reporting-stored-xss.md)
    * [Example 2: Reporting CSRF](hack-the-box/bug-bounty-hunter-path/bug-bounty-hunting-process/example-2-reporting-csrf.md)
    * [Example 3: Reporting RCE](hack-the-box/bug-bounty-hunter-path/bug-bounty-hunting-process/example-3-reporting-rce.md)
* [Extra Modules](hack-the-box/extra-modules/README.md)
  * [Windows Fundamentals](hack-the-box/extra-modules/windows-fundamentals/README.md)
    ...
    * [Core of the Operating System](hack-the-box/extra-modules/windows-fundamentals/core-of-the-operating-system/README.md)
      * [Operating System Structure](hack-the-box/extra-modules/windows-fundamentals/core-of-the-operating-system/operating-system-structure.md)
      * [File System](hack-the-box/extra-modules/windows-fundamentals/core-of-the-operating-system/file-system.md)
      * [NTFS vs Share Permissions](hack-the-box/extra-modules/windows-fundamentals/core-of-the-operating-system/ntfs-vs-share-permissions.md)
    * [Working with Services & Processes](hack-the-box/extra-modules/windows-fundamentals/working-with-services-and-processes/README.md)
      * [Windows Services & Processes](hack-the-box/extra-modules/windows-fundamentals/working-with-services-and-processes/windows-services-and-processes.md)
      * [Service Permissions](hack-the-box/extra-modules/windows-fundamentals/working-with-services-and-processes/service-permissions.md)
    * [Interacting with Windows](hack-the-box/extra-modules/windows-fundamentals/interacting-with-windows/README.md)
      * [Windows Sessions](hack-the-box/extra-modules/windows-fundamentals/interacting-with-windows/windows-sessions.md)
      * [Interacting with the Windows Operating System](hack-the-box/extra-modules/windows-fundamentals/interacting-with-windows/interacting-with-the-windows-operating-system.md)
      * [Windows Management Instrumentation (WMI)](hack-the-box/extra-modules/windows-fundamentals/interacting-with-windows/windows-management-instrumentation-wmi.md)
    * [Further Windows Usage](hack-the-box/extra-modules/windows-fundamentals/further-windows-usage/README.md)
      * [Microsoft Management Console (MMC)](hack-the-box/extra-modules/windows-fundamentals/further-windows-usage/microsoft-management-console-mmc.md)
      * [Windows Subsystem for Linux (WSL)](hack-the-box/extra-modules/windows-fundamentals/further-windows-usage/windows-subsystem-for-linux-wsl.md)
    * [Diving Deeper & Close Out](hack-the-box/extra-modules/windows-fundamentals/diving-deeper-and-close-out/README.md)
      * [Desktop Experience vs. Server Core](hack-the-box/extra-modules/windows-fundamentals/diving-deeper-and-close-out/desktop-experience-vs.-server-core.md)
      * [Windows Security](hack-the-box/extra-modules/windows-fundamentals/diving-deeper-and-close-out/windows-security.md)
  * [Introduction to Active Directory](hack-the-box/extra-modules/introduction-to-active-directory/README.md)
    * [Active Directory Overview](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-overview/README.md)
      * [Why Active Directory?](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-overview/why-active-directory.md)
      * [Active Directory Research Over the Years](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-overview/active-directory-research-over-the-years.md)
    * [Active Directory Fundamentals](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-fundamentals/README.md)
      * [AD Structure](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-fundamentals/ad-structure.md)
      * [AD Terminology](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-fundamentals/ad-terminology.md)
      * [Active Directory Objects](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-fundamentals/active-directory-objects.md)
      * [Active Directory Functionality](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-fundamentals/active-directory-functionality.md)
    * [Active Directory Protocols](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-protocols/README.md)
      * [Kerberos, DNS, LDAP, MSRPC](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-protocols/kerberos-dns-ldap-msrpc.md)
      * [NTLM Authentication](hack-the-box/extra-modules/introduction-to-active-directory/active-directory-protocols/ntlm-authentication.md)
    * [All About Users](hack-the-box/extra-modules/introduction-to-active-directory/all-about-users/README.md)
      * [User and Machine Accounts](hack-the-box/extra-modules/introduction-to-active-directory/all-about-users/user-and-machine-accounts.md)
      * [Active Directory Groups](hack-the-box/extra-modules/introduction-to-active-directory/all-about-users/active-directory-groups.md)
      * [Active Directory Rights and Privileges](hack-the-box/extra-modules/introduction-to-active-directory/all-about-users/active-directory-rights-and-privileges.md)
    * [Digging in Deeper](hack-the-box/extra-modules/introduction-to-active-directory/digging-in-deeper/README.md)
