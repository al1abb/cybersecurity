...
## Default Configuration, smb.conf file
...
```shell-session
al1abb@htb[/htb]$ rpcclient -U "" 10.129.14.128
...
```shell-session
al1abb@htb[/htb]$ for i in $(seq 500 1100);do rpcclient -N -U "" 10.129.14.128 -c "queryuser 0x$(printf '%x\n' $i)" | grep "User Name\|user_rid\|group_rid" && echo "";done
...
```shell-session
al1abb@htb[/htb]$ samrdump.py 10.129.14.128
...
```shell-session
al1abb@htb[/htb]$ crackmapexec smb 10.129.14.128 --shares -u '' -p ''
...
```shell-session
al1abb@htb[/htb]$ git clone https://github.com/cddmp/enum4linux-ng.git
al1abb@htb[/htb]$ cd enum4linux-ng
...
```shell-session
al1abb@htb[/htb]$ ./enum4linux-ng.py 10.129.14.128 -A
