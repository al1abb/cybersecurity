...
```bash
al1abb@htb[/htb]$ sudo nmap 10.129.2.28 -p50000 -sS -Pn -n --disable-arp-ping --packet-trace
...
```bash
al1abb@htb[/htb]$ sudo nmap 10.129.2.28 -p50000 -sS -Pn -n --disable-arp-ping --packet-trace --source-port 53
...
```bash
al1abb@htb[/htb]$ ncat -nv --source-port 53 10.129.2.28 50000
